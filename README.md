...
[![GoDoc](https://godoc.org/gopkg.in/fgrosse/goldi.v1?status.svg)](https://godoc.org/gopkg.in/fgrosse/goldi.v1)
...
## The goldi API
Goldi uses [semantic versioning][9] and is currently at major version 1.
You should use [gopkg.in][10] to get the version you want:

```
$ go get gopkg.in/fgrosse/goldi.v1
```
...
```
$ go get gopkg.in/fgrosse/goldi.v1/goldigen
```
...
// See https://gopkg.in/fgrosse/goldi.v1 for what is going on here.
...
[3]: http://godoc.org/gopkg.in/fgrosse/goldi.v1
